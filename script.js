...
let extension = ".xml";
let folio_xml = "../xml/" + tei_xml + extension;
...
function toggleDeletions() {
  ...
  deletions.forEach(function (deletion) {
    ...
    if (deletion.style.visibility === 'hidden' || deletion.style.visibility === '') {
...
function createToggleButton() {
  ...
  button.onclick = toggleDeletions;

  document.getElementById('button-container').appendChild(button);
}


//button that hides the notes
